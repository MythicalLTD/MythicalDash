...
$router->get('/api/admin/images', function () {
	...
	PermissionMiddleware::handle($appInstance, Permissions::ADMIN_IMAGES_LIST);
	$images = Image::getAll();
...
$router->post('/api/admin/images/create', function () {
	...
	PermissionMiddleware::handle($appInstance, Permissions::ADMIN_IMAGES_CREATE);
...
$router->post('/api/admin/images/(.*)/delete', function ($id) {
	...
	PermissionMiddleware::handle($appInstance, Permissions::ADMIN_IMAGES_DELETE);
	if (!Image::exists($id)) {
