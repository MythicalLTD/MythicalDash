...
$router->get('/api/user/earn/l4r/linkvertise/start', function (): void {
	...
	<body>
		<div class="container">
			...
			<a href="/api/user/earn/l4r/linkvertise/earn/<?= $linkvertiseUUID ?>" class="button">
			...
			<script>linkvertise(<?= $config->getSetting(ConfigInterface::L4R_LINKVERTISE_USER_ID, "583258") ?>, { whitelist: [], blacklist: [] });</script>
		</div>
	</body>
