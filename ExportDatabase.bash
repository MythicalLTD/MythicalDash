...
export_db() {
    ...
    /usr/bin/mariadb-dump -u root --no-data "$DB_NAME" --tables mythicaldash_apikeys mythicaldash_login_logs mythicaldash_logs mythicaldash_resetpasswords mythicaldash_settings mythicaldash_tickets mythicaldash_tickets_messages mythicaldash_users | /usr/bin/mariadb -u root "$TEMP_DB_NAME"
