        ...
        <div class="col-lg-8 card-wrapper">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><img src="https://i.imgur.com/jv3Frir.png" width="30"> Select what you want to buy</h3>
                </div>
                <div class="card-body" style="text-align: center;">
                    <p>Select what you want to buy.</p>
                    <a href="/store/resources"><button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;"><img src="<?= $getsettingsdb["proto"] . $_SERVER['SERVER_NAME']?>/assets/img/server.png" width="64"><br/><br/>Resources Stuff</button></a>
                    <a href="/store/account"><button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;"><img src="<?= $getsettingsdb["proto"] . $_SERVER['SERVER_NAME']?>/assets/img/usr.png" width="64"><br/><br/>Account Stuff</button></a>
                </div>
            </div>
        </div>
    </div>
