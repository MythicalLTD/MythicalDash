<template>
    <aside
        :class="[
            ...
            'lg:translate-x-0 bg-linear-to-br from-[#0F1322] via-[#0D0F1A] to-[#0A0E1A] border-r border-gray-800/30 shadow-2xl backdrop-blur-sm',
        ]"
    >
        <!-- Logo section -->
        <div class="p-6 border-b border-gray-800/30">
            <div class="flex items-center">
                <div
                    class="bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 p-2.5 rounded-xl shadow-lg mr-3 relative overflow-hidden"
                >
                    <div class="absolute inset-0 bg-linear-to-r from-white/20 to-transparent"></div>
                ...
                <div>
                    ...
                    <div class="flex items-center mt-1">
                        ...
                        <span
                            class="text-xs px-2 py-0.5 bg-linear-to-r from-indigo-500/30 to-purple-500/30 text-indigo-200 rounded-full border border-indigo-500/20"
                            >Admin</span
                        >
                    </div>
                </div>
