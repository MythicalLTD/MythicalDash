...
class Permissions {
    ...
    public static ADMIN_DASHBOARD_COMPONENTS_PREMIUM_VIEW = 'admin.dashboard.components.premiumedition.view';
    ...
    public static ADMIN_MYTHICALCLOUD_VIEW = 'admin.mythicalcloud.view';
    /** Download MythicalCloud backups */
    public static ADMIN_MYTHICALCLOUD_DOWNLOAD = 'admin.mythicalcloud.download';
    /** Upload files to MythicalCloud */
    public static ADMIN_MYTHICALCLOUD_UPLOAD = 'admin.mythicalcloud.upload';
    ...
    public static getAll(): Array<{ constant: string; value: string; category: string; description: string }> {
        return [
            ...
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_SYSTEM_OVERVIEW', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_SYSTEM_OVERVIEW, category: 'Admin Dashboard Components', description: 'View system overview component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_SYSTEM_UPDATES', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_SYSTEM_UPDATES, category: 'Admin Dashboard Components', description: 'View system updates component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_SYSTEM_LOGS', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_SYSTEM_LOGS, category: 'Admin Dashboard Components', description: 'View system logs component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_ANALYTICS_VIEW', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_ANALYTICS_VIEW, category: 'Admin Dashboard Components', description: 'View analytics at-a-glance component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_SUPPORT_VIEW', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_SUPPORT_VIEW, category: 'Admin Dashboard Components', description: 'View support component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_PREMIUM_VIEW', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_PREMIUM_VIEW, category: 'Admin Dashboard Components', description: 'View premium edition component' },
            { constant: 'ADMIN_DASHBOARD_COMPONENTS_GITHUB_VIEW', value: Permissions.ADMIN_DASHBOARD_COMPONENTS_GITHUB_VIEW, category: 'Admin Dashboard Components', description: 'View GitHub repository component' },
            ...
            { constant: 'ADMIN_LOCATIONS_CREATE', value: Permissions.ADMIN_LOCATIONS_CREATE, category: 'Admin Locations', description: 'Create new locations' },
