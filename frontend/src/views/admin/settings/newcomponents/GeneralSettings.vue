            ...
            <div class="pt-4 border-t border-gray-700">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        @input="markChanged('seo_description')"
                        rows="3"
                        class="bg-gray-800/30 border border-gray-700 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-pink-500"
                        placeholder="Enter a description for search engines..."
                    ></textarea>
                    <p class="mt-1 text-xs text-gray-500">
                        A brief description of your application for search engines. Recommended length: 150-160
                        characters.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        @input="markChanged('seo_keywords')"
                        class="bg-gray-800/30 border border-gray-700 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-pink-500"
                        placeholder="keyword1, keyword2, keyword3"
                    />
                    <p class="mt-1 text-xs text-gray-500">Comma-separated keywords for search engine optimization.</p>
                </div>
            </div>
