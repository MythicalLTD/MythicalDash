            ...
            <div class="flex items-center justify-between p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                ...
                <div class="flex items-center">
                    <input
                        ...
                        @change="updateSetting('image_hosting_enabled', formData.image_hosting_enabled)"
                ...
                <div class="flex items-center justify-between p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                    ...
                    <div class="flex items-center">
                        <input
                            ...
                            @change="
                                updateSetting(
                                    'image_hosting_coins_per_image_enabled',
                                    formData.image_hosting_coins_per_image_enabled,
                                )
                            "
                            class="w-4 h-4 text-pink-500 border-gray-600 rounded focus:ring-pink-500 focus:ring-offset-gray-800 bg-gray-700"
                        />
                ...
                <div class="p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                    <div class="flex flex-col">
                        ...
                        <input
                            ...
                            @change="
                                updateSetting('image_hosting_coins_per_image', formData.image_hosting_coins_per_image)
                            "
            ...
            <div class="p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                <div class="flex flex-col">
                    ...
                    <input
                        ...
                        @change="updateSetting('image_hosting_max_file_size', formData.image_hosting_max_file_size)"
                        class="bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-pink-500 text-white"
                    />
                </div>
            </div>
            ...
            <div class="flex items-center justify-between p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
                ...
                <div class="flex items-center">
                    <input
                        ...
                        @change="updateSetting('image_hosting_allow_domains', formData.image_hosting_allow_domains)"
                        class="w-4 h-4 text-pink-500 border-gray-600 rounded focus:ring-pink-500 focus:ring-offset-gray-800 bg-gray-700"
                    />
                </div>
            </div>
