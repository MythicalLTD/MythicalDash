        ...
        <div class="col-lg-8 card-wrapper">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><img src="<?= $getsettingsdb["proto"] . $_SERVER['SERVER_NAME']?>/assets/img/ticket_480px.png" width="30"> Select what you want to do</h3>
                </div>
                <div class="card-body" style="text-align: center;">
                    <p>Select what you want to buy.</p>
                    <a href="create_ticket"><button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;"><img src="<?= $getsettingsdb["proto"] . $_SERVER['SERVER_NAME']?>/assets/img/technical_support_400px.png" width="64"><br/><br/>Create a ticket</button></a>
                    <a href="tickets"><button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;"><img src="<?= $getsettingsdb["proto"] . $_SERVER['SERVER_NAME']?>/assets/img/technical_support_400px.png" width="64"><br/><br/>My tickets</button></a>
                </div>
            </div>
        </div>
    </div>
