          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div
              ...
              <h3 class="text-center">
                <?= $lang['help_center_help'] ?>
              </h3>
              <p class="text-center px-3 mb-0">
                <?= $lang['help_center_subhelp'] ?> <a href="help-center/tos">
                  <?= $lang['terms_of_service'] ?>
                </a>, <a href="help-center/pp">
                  <?= $lang['privacy_policy'] ?>
                </a>
              </p>
            </div>
            ...
            <div class="help-center-popular-articles bg-help-center py-5">
              <div class="container-xl">
                <h3 class="text-center my-4">
                  <?= $lang['help_center_popular_articles'] ?>
                </h3>
                <div class="row">
                      ...
                      <div class="col-md-4 mb-md-0 mb-4">
                        <div class="card border shadow-none">
                          <div class="card-body text-center">
                            ...
                            <p>
                              <?= $lang['help_center_tos_desc'] ?>
                            </p>
                            <a class="btn btn-sm btn-label-primary" href="/help-center/tos">
                              <?= $lang['help_center_read_more'] ?>
                            </a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-md-0 mb-4">
                        <div class="card border shadow-none">
                          <div class="card-body text-center">
                            ...
                            <h5 class="my-2">
                              <?= $lang['privacy_policy'] ?>
                              <?= $lang['help_center_pp_desc'] ?>
                            </h5>
                            <p></p>
                            <a class="btn btn-sm btn-label-primary" href="/help-center/pp">
                              <?= $lang['help_center_read_more'] ?>
                            </a>
                          </div>
                        </div>
              ...
              <div class="container-xl">
                <div class="row justify-content-center py-5">
                  <div class="col-md-8 col-lg-6 text-center mt-4">
                    <h3>
                      <?= $lang['help_center_still_need_help'] ?>
                    </h3>
                    <p class="mb-3">
                      <?= $lang['help_center_help_subtitle'] ?>
                    </p>
                    <div class="d-flex justify-content-center flex-wrap gap-4">
                      <a href="<?= SettingsManager::getSetting("discord_invite") ?>" class="btn btn-primary">
                        <?= $lang['help_center_visit_discord'] ?>
                      </a>
