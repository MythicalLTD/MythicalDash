              ...
              <div class="col-xl-9 col-lg-8 col-md-8">
                <div class="card overflow-hidden">
                  <div class="card-body">
                    ...
                    <?= $settings['name'] ?>
                    When we refer to "User", we are talking about you and we will also use words like "you" and "your"
                    to refer to you.
                    ...
                    The minimum age to create an account or any activity that requires your personal data is 13 years
                    old! If you are under 13, please contact us and request account deletion.
                    ...
                    verify your account details. If you do not provide it when we ask, your services will be suspended
                    without refund and your account will be banned.
                    We are not responsible for the security of your account. We recommend that you use a strong password
                    and do not give it to anyone. If your account gets hacked/lost, we can only help you recover it.
                    We will never sell your personal data.
                    </p>
                    <p>
                    <p class="text-big"> Support:</p>

                    We are under no obligation to install software / help you code on your site or any service got from
                    <?= $settings['name'] ?> / other host! We only provide the service, you have to work on it.
                    We are not responsible for your files.
                    You are not allowed to SPAM / make jokes / offend our staff or any activity that wastes our time. We
                    may suspend your services and ban your account.
                    We are not offering support in Discord DM / any other social media, support is only offered through
                    our Website. Any contact in Discord DM or any other social media will be ignored, further insistence
                    will get you banned and your services suspended.
                    ...
                    You are not allowed to use our servers for illegal purposes like DDoS, mining etc. Your server will
                    be suspended!
                    We are not required to install software (Pterodactyl, GameCP, etc.) on your server. We only offer
                    you the service. You have to work at it.
                    ...
                    Resource intensive users will not be supported in any form (eg: p2p communities - torrent trackers,
                    file hosting sites, image hosting sites, site statistics installations (above), game statistics,
                    installations external counters (redirecting players, etc.) will be suspended without refund!
                    ...
                    We reserve the right to adapt the hardware and software used to provide the services to the current
                    state of the art and to inform you in good time of any additional requirements that may arise from
                    this for the content you have stored on our servers. We undertake to make such adjustments only to a
                    reasonable extent and taking your interests into account.
