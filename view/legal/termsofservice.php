...
<head>
  ...
  <title>
    <?= SettingsManager::getSetting("name") ?> - <?= $lang['terms_of_service']?>
  </title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><?= $lang['help_center']?> /</span> <?= $lang['terms_of_service']?></h4>
            <div class="row">
              <div class="col-xl-3 col-lg-4 col-md-4 mb-lg-0 mb-4">
                ...
                <div class="nav-align-left">
                  <ul class="nav nav-pills border-0 w-100 gap-1">
                    ...
                    <li class="nav-item">
                      <button class="nav-link active" data-bs-target="javascript:void(0);"><?= $lang['terms_of_service']?></button>
                    </li>
                    <li class="nav-item">
                      <a href="/help-center/pp" class="nav-link"><?= $lang['privacy_policy']?></a>
                    </li>
                  </ul>
                </div>
              </div>
