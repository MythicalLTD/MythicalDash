...
--
-- Host: 193.34.77.154
-- Generation Time: May 07, 2026 at 01:02 PM
...
CREATE TABLE `coupons` (
  ...
  `isenabled` text NOT NULL DEFAULT 'true'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `aboutme` longtext NOT NULL DEFAULT '\'Hello and welcome to my profile page!\'',
  ...
  `support_type` enum('admin','user') NOT NULL DEFAULT 'user',
