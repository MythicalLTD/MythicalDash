...
$cpconn->query("UPDATE `users` SET `banned` = '1' WHERE `users`.`email` = '".$_GET['email']."';");
$cpconn->query("UPDATE `users` SET `banned_reason` = '".$_GET['reason']."' WHERE `users`.`email` = '".$_GET['email']."';");
$data = array(
    "error" => null
);
