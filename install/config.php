...
<h1 class="text-center">MythicalDash Configuration</h1>
  ...
  <form method="get" action="/server/config">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="servername" name="servername" placeholder="MythicalSystems" required>
    </div>
    <div class="form-group">
      <label for="serverlogo">Logo</label>
      <input type="text" class="form-control" id="serverlogo" name="serverlogo" value="<?= $fullURL ?>/assets/images/logo.png" placeholder="<?= $fullURL ?>/assets/images/logo.png">
    </div>
    <br>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="username" name="username" value="admin@mythicalsystems.tech" readonly="true">
    </div>
    <div class="form-group">
