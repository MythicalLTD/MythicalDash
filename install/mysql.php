...
<body>
  ...
  <div class="container mt-5">
    ...
    <p class="text-center">Enter your MySQL database information and click "Next" to check if the server can connect and
      set this as the main MySQL db.</p>
    <form method="get" action="/server/mysql">
      <div class="row g-3">
        <div class="mb-3 col-md-9">
          <label class="form-label" for="host">Host</label>
          <input name="host" type="text" class="form-control" id="host" placeholder="127.0.0.1"
            value="<?php if (isset($_GET['host'])) {
              echo $_GET['host'];
            } else {
            } ?>" required>
        </div>
