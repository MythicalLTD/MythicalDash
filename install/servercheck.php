...
<div class="container mt-5">
  ...
  <p class="text-center">We don't support this php version make sure to install <code>php8.x</code> version to run mythicaldash:</p>
    <div class="alert alert-danger text-center">apt -y install php8.2 php8.2-{common,cli,gd,mysql,opcache,soap,mbstring,bcmath,xml,fpm,curl,zip,xmlrpc,imagick,dev,imap,intl} && sudo a2enmod php8.1</div>
</div>
    ...
    if (!extension_loaded($ext)) {
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container mt-5">
          ...
          <p class="text-center">The extension: <code><?=$ext?></code> can't be found on your server, make sure to install all extension by: </p>
            <div class="alert alert-danger text-center">
            apt -y install php8.2 php8.2-{common,cli,gd,mysql,opcache,soap,mbstring,bcmath,xml,fpm,curl,zip,xmlrpc,imagick,dev,imap,intl}
            </div>
        </div>
        <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/2.11.8/umd/popper.min.js"></script>
